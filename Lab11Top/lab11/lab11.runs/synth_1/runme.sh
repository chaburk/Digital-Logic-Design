...
HD_PWD='H:/EECS140_LAB/lab11/lab11.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log threeeightdecoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source threeeightdecoder.tcl
