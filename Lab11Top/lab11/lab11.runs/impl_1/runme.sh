...
HD_PWD='H:/EECS140_LAB/lab11/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log threeeightdecoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source threeeightdecoder.tcl -notrace
