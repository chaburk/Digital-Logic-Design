...
HD_PWD='H:/EECS140_LAB/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log burkdoll_lab2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source burkdoll_lab2.tcl -notrace
