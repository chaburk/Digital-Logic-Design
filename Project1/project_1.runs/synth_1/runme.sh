...
HD_PWD='H:/EECS140_LAB/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log burkdoll_lab2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source burkdoll_lab2.tcl
