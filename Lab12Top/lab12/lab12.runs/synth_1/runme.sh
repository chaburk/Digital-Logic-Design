...
HD_PWD='H:/EECS140_LAB/lab12/lab12.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log masterslave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source masterslave.tcl
