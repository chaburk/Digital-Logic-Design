...
HD_PWD='H:/EECS140_LAB/lab12/lab12.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log masterslave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source masterslave.tcl -notrace
