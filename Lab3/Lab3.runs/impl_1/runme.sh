...
HD_PWD='H:/EECS140_LAB/Lab3/Lab3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log burkdoll_lab3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source burkdoll_lab3.tcl -notrace
