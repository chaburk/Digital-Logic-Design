...
HD_PWD='H:/EECS140_LAB/Lab3/Lab3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log burkdoll_lab3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source burkdoll_lab3.tcl
